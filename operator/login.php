            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header text-center">
                        <h4 class="modal-title w-100 font-bold">Masuk Operator</h4>
...
<?php
    ...
    if(isset($_POST['Login'])){
        ...
        $queryLogin = "SELECT * FROM tabel_operator WHERE tabel_operator_username = '$username' AND tabel_operator_password_md5 = '$passwordmd5'";
        $ambil = mysqli_query($Connection, $queryLogin);
        
        $hitung = mysqli_num_rows($ambil);
        $pecah = mysqli_fetch_array($ambil);
        if($hitung>0){
            $_SESSION['id_tabel_operator'] = $pecah['id_tabel_operator'];
            $_SESSION['tabel_operator_username'] = $pecah['tabel_operator_username'];
