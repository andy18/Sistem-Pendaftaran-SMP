...
<?php
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
    <a class="navbar-brand" href="index.php">Sistem Informasi Sekolah Dasar</a>
    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
	  ...
	  -->
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Tables">
          <a class="nav-link" href="index.php?menu=isiNilai">
            <i class="fa fa-fw fa-table"></i>
            <span class="nav-link-text">Isi Nilai</span>
          </a>
        </li>
		<li class="nav-item" data-toggle="tooltip" data-placement="right" title="Tables">
          <a class="nav-link" href="index.php?menu=daftarNilai">
            <i class="fa fa-fw fa-table"></i>
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">Pilih "Logout" untuk keluar dari menu Admin.</div>
