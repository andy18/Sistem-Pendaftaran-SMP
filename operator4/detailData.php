...
<body>
    ...
    <?php
        ...
        $queryTampil2 = "SELECT * FROM `tabel_ayah` WHERE id_tabel_ayah= '$idAyah'";
        ...
        $queryTampil4 = "SELECT * FROM `tabel_wali` WHERE id_tabel_wali= '$idWali'";

        $eksekusi4 = mysqli_query($Connection, $queryTampil4);
        $data4 = mysqli_fetch_array($eksekusi4);
        
        $queryTampil5 = "SELECT * FROM `tabel_user` WHERE id_tabel_pendaftar= '$idPendaftar'";

        $eksekusi5 = mysqli_query($Connection, $queryTampil5);
        $data5 = mysqli_fetch_array($eksekusi5);
    ...
    <div class="card-body">
            <div class="row">
                <!--First column-->
                    <div class="col-md-3">
                        <div class="md-form">
                            <div align="left"><h3>Username</h3></div>
                        </div>
                    </div>

                    <div class="col-md-3">
                        <div class="md-form">
                            <div align="left"><strong>: <?=$data5['tabel_user_username']?></strong></div>
                        </div>
                    </div>
            ...
            <div class="row">
                <!--First column-->
                    <div class="col-md-3">
                        <div class="md-form">
                            <div align="left"><h3>Password</h3></div>
                        </div>
                    </div>

                    <div class="col-md-3">
                        <div class="md-form">
                            <div align="left"><strong>: <?=$data5['tabel_user_password']?></strong></div>
                        </div>
                    </div>
