<?php
	...
	$query = "SELECT * FROM tabel_user WHERE tabel_user_username='".$user."' AND tabel_user_password_md5='".$pass."'";
	$eksekusi = mysqli_query($Connection, $query);
    $num = mysqli_num_rows($eksekusi);
	$data = mysqli_fetch_array($eksekusi);
	//echo "1";
	if($num > 0)
	{
		//echo $data["id_tabel_pendaftar"];
		//echo "1";
		$query1 = "SELECT * FROM tabel_verifikasi WHERE id_tabel_pendaftar = '".$data["id_tabel_pendaftar"]."'";
		$eksekusi1 = mysqli_query($Connection, $query1);
		$num1 = mysqli_num_rows($eksekusi1);
...
<html lang="en">
    ...
    <link href="https://fonts.googleapis.com/css?family=Work+Sans:300,400,700" rel="stylesheet">
		...
		<link rel="stylesheet" href="tampilan3/assets/css/bootstrap/bootstrap.css">
    <link rel="stylesheet" href="tampilan3/assets/css/animate.css">
    <link rel="stylesheet" href="tampilan3/assets/fonts/ionicons/css/ionicons.min.css">
    
    <link rel="stylesheet" href="tampilan3/assets/css/owl.carousel.min.css">
    
    <link rel="stylesheet" href="tampilan3/assets/fonts/flaticon/font/flaticon.css">

    <link rel="stylesheet" href="tampilan3/assets/fonts/fontawesome/css/font-awesome.min.css">
    <link rel="stylesheet" href="tampilan3/assets/css/bootstrap-datepicker.css">
    <link rel="stylesheet" href="tampilan3/assets/css/select2.css">
    

    <link rel="stylesheet" href="tampilan3/assets/css/helpers.css">
    <link rel="stylesheet" href="tampilan3/assets/css/style.css">
    ...
    <section class="probootstrap-cover overflow-hidden relative"  style="background-image: url('assets/images/bg_1.jpg');" data-stellar-background-ratio="0.5"  id="section-home">
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-md">
            <h2 class="heading mb-2 display-4 font-light probootstrap-animate">PENGUMUMAN</h2>
            <p class="lead mb-5 probootstrap-animate">
              

            </p>
              <a href="index.php" role="button" class="btn btn-primary p-3 mr-3 pl-5 pr-5 text-uppercase d-lg-inline d-md-inline d-sm-block d-block mb-3">Kembali</a> 
            </p>
          </div> 
		  
		  <div class="col-md probootstrap-animate"  >
		 <?php
					if($data1["tabel_verifikasi_ket"] == "Lulus"){?>
						<img src="img/lulus.jpg" />
					<?php }else {?>
						<img src="img/tidak_lulus.jpg"/>
					<?php
					}
				  ?>
    ...
    -->
    <script src="tampilan3/assets/js/jquery.min.js"></script>
    
    <script src="tampilan3/assets/js/popper.min.js"></script>
    <script src="tampilan3/assets/js/bootstrap.min.js"></script>
    <script src="tampilan3/assets/js/owl.carousel.min.js"></script>

    <script src="tampilan3/assets/js/bootstrap-datepicker.js"></script>
    <script src="tampilan3/assets/js/jquery.waypoints.min.js"></script>
    <script src="tampilan3/assets/js/jquery.easing.1.3.js"></script>

    <script src="tampilan3/assets/js/select2.min.js"></script>

    <script src="tampilan3/assets/js/main.js"></script>
	</body>
</html>